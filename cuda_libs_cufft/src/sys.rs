...
pub struct DynamicBindings {
    ...
    >,
    pub cufftGetPlanPropertyInt64: Option<
        unsafe extern "C" fn(
            plan: cufftHandle,
            property: cufftProperty,
            returnPtrValue: *mut ::std::os::raw::c_longlong,
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn cufftPlan2d(
    plan: *mut cufftHandle,
    nx: ::std::os::raw::c_int,
    ny: ::std::os::raw::c_int,
    type_: cufftType,
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn cufftPlan3d(
    plan: *mut cufftHandle,
    nx: ::std::os::raw::c_int,
    ny: ::std::os::raw::c_int,
    nz: ::std::os::raw::c_int,
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn cufftMakePlan1d(
    plan: cufftHandle,
    nx: ::std::os::raw::c_int,
    type_: cufftType,
    batch: ::std::os::raw::c_int,
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn cufftMakePlan2d(
    plan: cufftHandle,
    nx: ::std::os::raw::c_int,
    ny: ::std::os::raw::c_int,
    type_: cufftType,
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn cufftMakePlan3d(
    plan: cufftHandle,
    nx: ::std::os::raw::c_int,
    ny: ::std::os::raw::c_int,
    nz: ::std::os::raw::c_int,
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn cufftEstimate1d(
    nx: ::std::os::raw::c_int,
    type_: cufftType,
    batch: ::std::os::raw::c_int,
    workSize: *mut usize,
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn cufftEstimate2d(
    nx: ::std::os::raw::c_int,
    ny: ::std::os::raw::c_int,
    type_: cufftType,
    workSize: *mut usize,
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn cufftEstimate3d(
    nx: ::std::os::raw::c_int,
    ny: ::std::os::raw::c_int,
    nz: ::std::os::raw::c_int,
    type_: cufftType,
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn cufftGetSize1d(
    handle: cufftHandle,
    nx: ::std::os::raw::c_int,
    type_: cufftType,
    batch: ::std::os::raw::c_int,
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn cufftGetSize2d(
    handle: cufftHandle,
    nx: ::std::os::raw::c_int,
    ny: ::std::os::raw::c_int,
    type_: cufftType,
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn cufftGetSize3d(
    handle: cufftHandle,
    nx: ::std::os::raw::c_int,
    ny: ::std::os::raw::c_int,
    nz: ::std::os::raw::c_int,
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn cufftExecR2C(
    plan: cufftHandle,
    idata: *mut cufftReal,
    odata: *mut cufftComplex,
) -> cufftResult {
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn cufftExecC2R(
    plan: cufftHandle,
    idata: *mut cufftComplex,
    odata: *mut cufftReal,
) -> cufftResult {
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn cufftExecZ2Z(
    plan: cufftHandle,
    idata: *mut cufftDoubleComplex,
    odata: *mut cufftDoubleComplex,
    direction: ::std::os::raw::c_int,
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn cufftExecD2Z(
    plan: cufftHandle,
    idata: *mut cufftDoubleReal,
    odata: *mut cufftDoubleComplex,
) -> cufftResult {
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn cufftExecZ2D(
    plan: cufftHandle,
    idata: *mut cufftDoubleComplex,
    odata: *mut cufftDoubleReal,
) -> cufftResult {
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn cufftGetProperty(
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn cufftSetPlanPropertyInt64(
    plan: cufftHandle,
    property: cufftProperty,
    inputValueInt: ::std::os::raw::c_longlong,
) -> cufftResult {
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn cufftGetPlanPropertyInt64(
    plan: cufftHandle,
    property: cufftProperty,
    returnPtrValue: *mut ::std::os::raw::c_longlong,
) -> cufftResult {
