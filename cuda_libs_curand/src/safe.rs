...
impl crate::sys::DynamicBindings {
    ...
    pub fn curandGetVersion(mut self, val: Option<unsafe extern "C" fn(*mut ::core::ffi::c_int) -> curandStatus_t>) -> Self {
        self.curandGetVersion = val;
        self
    }
    pub fn curandGetProperty(mut self, val: Option<unsafe extern "C" fn(libraryPropertyType, *mut ::core::ffi::c_int) -> curandStatus_t>) -> Self {
    ...
    pub fn curandSetPseudoRandomGeneratorSeed(mut self, val: Option<unsafe extern "C" fn(curandGenerator_t, ::core::ffi::c_ulonglong) -> curandStatus_t>) -> Self {
        self.curandSetPseudoRandomGeneratorSeed = val;
        self
    }
    pub fn curandSetGeneratorOffset(mut self, val: Option<unsafe extern "C" fn(curandGenerator_t, ::core::ffi::c_ulonglong) -> curandStatus_t>) -> Self {
    ...
    pub fn curandSetQuasiRandomGeneratorDimensions(mut self, val: Option<unsafe extern "C" fn(curandGenerator_t, ::core::ffi::c_uint) -> curandStatus_t>) -> Self {
        self.curandSetQuasiRandomGeneratorDimensions = val;
        self
    }
    pub fn curandGenerate(mut self, val: Option<unsafe extern "C" fn(curandGenerator_t, *mut ::core::ffi::c_uint, usize) -> curandStatus_t>) -> Self {
        self.curandGenerate = val;
        self
    }
    pub fn curandGenerateLongLong(mut self, val: Option<unsafe extern "C" fn(curandGenerator_t, *mut ::core::ffi::c_ulonglong, usize) -> curandStatus_t>) -> Self {
    ...
    pub fn curandGeneratePoisson(mut self, val: Option<unsafe extern "C" fn(curandGenerator_t, *mut ::core::ffi::c_uint, usize, f64) -> curandStatus_t>) -> Self {
        self.curandGeneratePoisson = val;
        self
    }
    pub fn curandGeneratePoissonMethod(mut self, val: Option<unsafe extern "C" fn(curandGenerator_t, *mut ::core::ffi::c_uint, usize, f64, curandMethod_t) -> curandStatus_t>) -> Self {
        self.curandGeneratePoissonMethod = val;
        self
    }
    pub fn curandGenerateBinomial(mut self, val: Option<unsafe extern "C" fn(curandGenerator_t, *mut ::core::ffi::c_uint, usize, ::core::ffi::c_uint, f64) -> curandStatus_t>) -> Self {
        self.curandGenerateBinomial = val;
        self
    }
    pub fn curandGenerateBinomialMethod(mut self, val: Option<unsafe extern "C" fn(curandGenerator_t, *mut ::core::ffi::c_uint, usize, ::core::ffi::c_uint, f64, curandMethod_t) -> curandStatus_t>) -> Self {
    ...
    pub fn curandGetScrambleConstants32(mut self, val: Option<unsafe extern "C" fn(*mut *mut ::core::ffi::c_uint) -> curandStatus_t>) -> Self {
    ...
    pub fn curandGetScrambleConstants64(mut self, val: Option<unsafe extern "C" fn(*mut *mut ::core::ffi::c_ulonglong) -> curandStatus_t>) -> Self {
...
pub unsafe fn curandGetVersion() -> Result<::core::ffi::c_int, crate::sys::curandStatus_t> {
...
pub unsafe fn curandGetProperty(type_: libraryPropertyType) -> Result<::core::ffi::c_int, crate::sys::curandStatus_t> {
...
pub unsafe fn curandSetPseudoRandomGeneratorSeed(generator: curandGenerator_t, seed: ::core::ffi::c_ulonglong) -> Result<(), crate::sys::curandStatus_t> {
    let status = unsafe { crate::sys::curandSetPseudoRandomGeneratorSeed(generator, seed) };
    if status == crate::sys::curandStatus_t::CURAND_STATUS_SUCCESS { Ok(()) } else { Err(status) }
}
...
pub unsafe fn curandSetGeneratorOffset(generator: curandGenerator_t, offset: ::core::ffi::c_ulonglong) -> Result<(), crate::sys::curandStatus_t> {
    let status = unsafe { crate::sys::curandSetGeneratorOffset(generator, offset) };
    if status == crate::sys::curandStatus_t::CURAND_STATUS_SUCCESS { Ok(()) } else { Err(status) }
}
...
pub unsafe fn curandSetQuasiRandomGeneratorDimensions(generator: curandGenerator_t, num_dimensions: ::core::ffi::c_uint) -> Result<(), crate::sys::curandStatus_t> {
    let status = unsafe { crate::sys::curandSetQuasiRandomGeneratorDimensions(generator, num_dimensions) };
    if status == crate::sys::curandStatus_t::CURAND_STATUS_SUCCESS { Ok(()) } else { Err(status) }
}
...
pub unsafe fn curandGenerateBinomial<T0: types::CudaAsMutPtr>(generator: curandGenerator_t, mut outputPtr: T0, num: usize, n: ::core::ffi::c_uint, p: f64) -> Result<(), crate::sys::curandStatus_t> {
    let status = unsafe { crate::sys::curandGenerateBinomial(generator, outputPtr.as_mut_ptr() as *mut _, num, n, p) };
    if status == crate::sys::curandStatus_t::CURAND_STATUS_SUCCESS { Ok(()) } else { Err(status) }
}
pub unsafe fn curandGenerateBinomialMethod<T0: types::CudaAsMutPtr>(generator: curandGenerator_t, mut outputPtr: T0, num: usize, n: ::core::ffi::c_uint, p: f64, method: curandMethod_t) -> Result<(), crate::sys::curandStatus_t> {
    let status = unsafe { crate::sys::curandGenerateBinomialMethod(generator, outputPtr.as_mut_ptr() as *mut _, num, n, p, method) };
    if status == crate::sys::curandStatus_t::CURAND_STATUS_SUCCESS { Ok(()) } else { Err(status) }
}
...
pub unsafe fn curandGetScrambleConstants32() -> Result<*mut ::core::ffi::c_uint, crate::sys::curandStatus_t> {
    let mut out_0: std::mem::MaybeUninit<*mut ::core::ffi::c_uint> = std::mem::MaybeUninit::zeroed();
    let status = unsafe { crate::sys::curandGetScrambleConstants32(out_0.as_mut_ptr() as *mut _) };
    if status as usize == crate::sys::curandStatus_t::CURAND_STATUS_SUCCESS as usize {
        unsafe { Ok(out_0.assume_init() as *mut ::core::ffi::c_uint) }
    } else {
        Err(unsafe { std::mem::transmute(status) })
    }
}
...
pub unsafe fn curandGetScrambleConstants64() -> Result<*mut ::core::ffi::c_ulonglong, crate::sys::curandStatus_t> {
    let mut out_0: std::mem::MaybeUninit<*mut ::core::ffi::c_ulonglong> = std::mem::MaybeUninit::zeroed();
    let status = unsafe { crate::sys::curandGetScrambleConstants64(out_0.as_mut_ptr() as *mut _) };
    if status as usize == crate::sys::curandStatus_t::CURAND_STATUS_SUCCESS as usize {
        unsafe { Ok(out_0.assume_init() as *mut ::core::ffi::c_ulonglong) }
    } else {
        Err(unsafe { std::mem::transmute(status) })
    }
}
