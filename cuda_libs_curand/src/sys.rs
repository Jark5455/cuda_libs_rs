...
unsafe extern "C" {
    ...
    pub fn curandGetProperty(type_: libraryPropertyType, value: *mut ::core::ffi::c_int) -> curandStatus_t;
}
#[cfg(not(feature = "runtime-link"))]
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn curandSetPseudoRandomGeneratorSeed(generator: curandGenerator_t, seed: ::core::ffi::c_ulonglong) -> curandStatus_t;
}
#[cfg(not(feature = "runtime-link"))]
unsafe extern "C" {
    ...
    pub fn curandSetGeneratorOffset(generator: curandGenerator_t, offset: ::core::ffi::c_ulonglong) -> curandStatus_t;
}
#[cfg(not(feature = "runtime-link"))]
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn curandSetQuasiRandomGeneratorDimensions(generator: curandGenerator_t, num_dimensions: ::core::ffi::c_uint) -> curandStatus_t;
}
#[cfg(not(feature = "runtime-link"))]
unsafe extern "C" {
    ...
    pub fn curandGenerate(generator: curandGenerator_t, outputPtr: *mut ::core::ffi::c_uint, num: usize) -> curandStatus_t;
}
#[cfg(not(feature = "runtime-link"))]
unsafe extern "C" {
    ...
    pub fn curandGenerateLongLong(generator: curandGenerator_t, outputPtr: *mut ::core::ffi::c_ulonglong, num: usize) -> curandStatus_t;
}
#[cfg(not(feature = "runtime-link"))]
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn curandGenerateUniformDouble(generator: curandGenerator_t, outputPtr: *mut f64, num: usize) -> curandStatus_t;
}
#[cfg(not(feature = "runtime-link"))]
unsafe extern "C" {
    ...
    pub fn curandGenerateNormal(generator: curandGenerator_t, outputPtr: *mut f32, n: usize, mean: f32, stddev: f32) -> curandStatus_t;
}
#[cfg(not(feature = "runtime-link"))]
unsafe extern "C" {
    ...
    pub fn curandGenerateNormalDouble(generator: curandGenerator_t, outputPtr: *mut f64, n: usize, mean: f64, stddev: f64) -> curandStatus_t;
}
#[cfg(not(feature = "runtime-link"))]
unsafe extern "C" {
    ...
    pub fn curandGenerateLogNormal(generator: curandGenerator_t, outputPtr: *mut f32, n: usize, mean: f32, stddev: f32) -> curandStatus_t;
}
#[cfg(not(feature = "runtime-link"))]
unsafe extern "C" {
    ...
    pub fn curandGenerateLogNormalDouble(generator: curandGenerator_t, outputPtr: *mut f64, n: usize, mean: f64, stddev: f64) -> curandStatus_t;
}
#[cfg(not(feature = "runtime-link"))]
unsafe extern "C" {
    ...
    pub fn curandCreatePoissonDistribution(lambda: f64, discrete_distribution: *mut curandDiscreteDistribution_t) -> curandStatus_t;
}
#[cfg(not(feature = "runtime-link"))]
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn curandGeneratePoisson(generator: curandGenerator_t, outputPtr: *mut ::core::ffi::c_uint, n: usize, lambda: f64) -> curandStatus_t;
}
#[cfg(not(feature = "runtime-link"))]
unsafe extern "C" {
    pub fn curandGeneratePoissonMethod(generator: curandGenerator_t, outputPtr: *mut ::core::ffi::c_uint, n: usize, lambda: f64, method: curandMethod_t) -> curandStatus_t;
}
#[cfg(not(feature = "runtime-link"))]
unsafe extern "C" {
    pub fn curandGenerateBinomial(generator: curandGenerator_t, outputPtr: *mut ::core::ffi::c_uint, num: usize, n: ::core::ffi::c_uint, p: f64) -> curandStatus_t;
}
#[cfg(not(feature = "runtime-link"))]
unsafe extern "C" {
    pub fn curandGenerateBinomialMethod(generator: curandGenerator_t, outputPtr: *mut ::core::ffi::c_uint, num: usize, n: ::core::ffi::c_uint, p: f64, method: curandMethod_t) -> curandStatus_t;
}
#[cfg(not(feature = "runtime-link"))]
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn curandGetDirectionVectors32(vectors: *mut *mut curandDirectionVectors32_t, set: curandDirectionVectorSet_t) -> curandStatus_t;
}
#[cfg(not(feature = "runtime-link"))]
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn curandGetDirectionVectors64(vectors: *mut *mut curandDirectionVectors64_t, set: curandDirectionVectorSet_t) -> curandStatus_t;
}
#[cfg(not(feature = "runtime-link"))]
unsafe extern "C" {
    ...
    pub fn curandGetScrambleConstants64(constants: *mut *mut ::core::ffi::c_ulonglong) -> curandStatus_t;
}
...
pub struct DynamicBindings {
    ...
    pub curandGetVersion: Option<unsafe extern "C" fn(*mut ::core::ffi::c_int) -> curandStatus_t>,
    pub curandGetProperty: Option<unsafe extern "C" fn(libraryPropertyType, *mut ::core::ffi::c_int) -> curandStatus_t>,
    pub curandSetStream: Option<unsafe extern "C" fn(curandGenerator_t, cudaStream_t) -> curandStatus_t>,
    pub curandSetPseudoRandomGeneratorSeed: Option<unsafe extern "C" fn(curandGenerator_t, ::core::ffi::c_ulonglong) -> curandStatus_t>,
    pub curandSetGeneratorOffset: Option<unsafe extern "C" fn(curandGenerator_t, ::core::ffi::c_ulonglong) -> curandStatus_t>,
    pub curandSetGeneratorOrdering: Option<unsafe extern "C" fn(curandGenerator_t, curandOrdering_t) -> curandStatus_t>,
    pub curandSetQuasiRandomGeneratorDimensions: Option<unsafe extern "C" fn(curandGenerator_t, ::core::ffi::c_uint) -> curandStatus_t>,
    pub curandGenerate: Option<unsafe extern "C" fn(curandGenerator_t, *mut ::core::ffi::c_uint, usize) -> curandStatus_t>,
    pub curandGenerateLongLong: Option<unsafe extern "C" fn(curandGenerator_t, *mut ::core::ffi::c_ulonglong, usize) -> curandStatus_t>,
    ...
    pub curandGeneratePoisson: Option<unsafe extern "C" fn(curandGenerator_t, *mut ::core::ffi::c_uint, usize, f64) -> curandStatus_t>,
    pub curandGeneratePoissonMethod: Option<unsafe extern "C" fn(curandGenerator_t, *mut ::core::ffi::c_uint, usize, f64, curandMethod_t) -> curandStatus_t>,
    pub curandGenerateBinomial: Option<unsafe extern "C" fn(curandGenerator_t, *mut ::core::ffi::c_uint, usize, ::core::ffi::c_uint, f64) -> curandStatus_t>,
    pub curandGenerateBinomialMethod: Option<unsafe extern "C" fn(curandGenerator_t, *mut ::core::ffi::c_uint, usize, ::core::ffi::c_uint, f64, curandMethod_t) -> curandStatus_t>,
    ...
    pub curandGetScrambleConstants32: Option<unsafe extern "C" fn(*mut *mut ::core::ffi::c_uint) -> curandStatus_t>,
    ...
    pub curandGetScrambleConstants64: Option<unsafe extern "C" fn(*mut *mut ::core::ffi::c_ulonglong) -> curandStatus_t>,
}
#[cfg(feature = "runtime-link")]
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandCreateGenerator(generator: *mut curandGenerator_t, rng_type: curandRngType_t) -> curandStatus_t {
    match DYNAMIC_BINDINGS.get().expect("CUDA library not loaded. Did you forget to call #[cuda_load]?").curandCreateGenerator {
        Some(____func) => unsafe { ____func(generator, rng_type) },
        None => panic!("CUDA symbol '{}' not found in the loaded library. This typically happens when using a CUDA version older than the one the bindings were generated for.", "curandCreateGenerator"),
    }
}
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandCreateGeneratorHost(generator: *mut curandGenerator_t, rng_type: curandRngType_t) -> curandStatus_t {
    match DYNAMIC_BINDINGS.get().expect("CUDA library not loaded. Did you forget to call #[cuda_load]?").curandCreateGeneratorHost {
        Some(____func) => unsafe { ____func(generator, rng_type) },
        None => panic!(
...
pub unsafe extern "C" fn curandDestroyGenerator(generator: curandGenerator_t) -> curandStatus_t {
    match DYNAMIC_BINDINGS.get().expect("CUDA library not loaded. Did you forget to call #[cuda_load]?").curandDestroyGenerator {
        Some(____func) => unsafe { ____func(generator) },
        None => panic!("CUDA symbol '{}' not found in the loaded library. This typically happens when using a CUDA version older than the one the bindings were generated for.", "curandDestroyGenerator"),
    }
}
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandGetVersion(version: *mut ::core::ffi::c_int) -> curandStatus_t {
    match DYNAMIC_BINDINGS.get().expect("CUDA library not loaded. Did you forget to call #[cuda_load]?").curandGetVersion {
        Some(____func) => unsafe { ____func(version) },
        None => panic!("CUDA symbol '{}' not found in the loaded library. This typically happens when using a CUDA version older than the one the bindings were generated for.", "curandGetVersion"),
    }
}
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandGetProperty(type_: libraryPropertyType, value: *mut ::core::ffi::c_int) -> curandStatus_t {
    match DYNAMIC_BINDINGS.get().expect("CUDA library not loaded. Did you forget to call #[cuda_load]?").curandGetProperty {
        Some(____func) => unsafe { ____func(type_, value) },
        None => panic!("CUDA symbol '{}' not found in the loaded library. This typically happens when using a CUDA version older than the one the bindings were generated for.", "curandGetProperty"),
    }
}
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandSetStream(generator: curandGenerator_t, stream: cudaStream_t) -> curandStatus_t {
    match DYNAMIC_BINDINGS.get().expect("CUDA library not loaded. Did you forget to call #[cuda_load]?").curandSetStream {
        Some(____func) => unsafe { ____func(generator, stream) },
        None => panic!("CUDA symbol '{}' not found in the loaded library. This typically happens when using a CUDA version older than the one the bindings were generated for.", "curandSetStream"),
    }
}
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandSetPseudoRandomGeneratorSeed(generator: curandGenerator_t, seed: ::core::ffi::c_ulonglong) -> curandStatus_t {
    match DYNAMIC_BINDINGS.get().expect("CUDA library not loaded. Did you forget to call #[cuda_load]?").curandSetPseudoRandomGeneratorSeed {
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandSetGeneratorOffset(generator: curandGenerator_t, offset: ::core::ffi::c_ulonglong) -> curandStatus_t {
    match DYNAMIC_BINDINGS.get().expect("CUDA library not loaded. Did you forget to call #[cuda_load]?").curandSetGeneratorOffset {
        Some(____func) => unsafe { ____func(generator, offset) },
        None => panic!("CUDA symbol '{}' not found in the loaded library. This typically happens when using a CUDA version older than the one the bindings were generated for.", "curandSetGeneratorOffset"),
    }
}
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandSetGeneratorOrdering(generator: curandGenerator_t, order: curandOrdering_t) -> curandStatus_t {
    match DYNAMIC_BINDINGS.get().expect("CUDA library not loaded. Did you forget to call #[cuda_load]?").curandSetGeneratorOrdering {
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandSetQuasiRandomGeneratorDimensions(generator: curandGenerator_t, num_dimensions: ::core::ffi::c_uint) -> curandStatus_t {
    match DYNAMIC_BINDINGS.get().expect("CUDA library not loaded. Did you forget to call #[cuda_load]?").curandSetQuasiRandomGeneratorDimensions {
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandGenerate(generator: curandGenerator_t, outputPtr: *mut ::core::ffi::c_uint, num: usize) -> curandStatus_t {
    match DYNAMIC_BINDINGS.get().expect("CUDA library not loaded. Did you forget to call #[cuda_load]?").curandGenerate {
        Some(____func) => unsafe { ____func(generator, outputPtr, num) },
        None => panic!("CUDA symbol '{}' not found in the loaded library. This typically happens when using a CUDA version older than the one the bindings were generated for.", "curandGenerate"),
    }
}
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandGenerateLongLong(generator: curandGenerator_t, outputPtr: *mut ::core::ffi::c_ulonglong, num: usize) -> curandStatus_t {
    match DYNAMIC_BINDINGS.get().expect("CUDA library not loaded. Did you forget to call #[cuda_load]?").curandGenerateLongLong {
        Some(____func) => unsafe { ____func(generator, outputPtr, num) },
        None => panic!("CUDA symbol '{}' not found in the loaded library. This typically happens when using a CUDA version older than the one the bindings were generated for.", "curandGenerateLongLong"),
    }
}
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandGenerateUniform(generator: curandGenerator_t, outputPtr: *mut f32, num: usize) -> curandStatus_t {
    match DYNAMIC_BINDINGS.get().expect("CUDA library not loaded. Did you forget to call #[cuda_load]?").curandGenerateUniform {
        Some(____func) => unsafe { ____func(generator, outputPtr, num) },
        None => panic!("CUDA symbol '{}' not found in the loaded library. This typically happens when using a CUDA version older than the one the bindings were generated for.", "curandGenerateUniform"),
    }
}
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandGenerateUniformDouble(generator: curandGenerator_t, outputPtr: *mut f64, num: usize) -> curandStatus_t {
    match DYNAMIC_BINDINGS.get().expect("CUDA library not loaded. Did you forget to call #[cuda_load]?").curandGenerateUniformDouble {
        Some(____func) => unsafe { ____func(generator, outputPtr, num) },
        None => panic!(
            "CUDA symbol '{}' not found in the loaded library. This typically happens when using a CUDA version older than the one the bindings were generated for.",
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandGenerateNormal(generator: curandGenerator_t, outputPtr: *mut f32, n: usize, mean: f32, stddev: f32) -> curandStatus_t {
    match DYNAMIC_BINDINGS.get().expect("CUDA library not loaded. Did you forget to call #[cuda_load]?").curandGenerateNormal {
        Some(____func) => unsafe { ____func(generator, outputPtr, n, mean, stddev) },
        None => panic!("CUDA symbol '{}' not found in the loaded library. This typically happens when using a CUDA version older than the one the bindings were generated for.", "curandGenerateNormal"),
    }
}
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandGenerateNormalDouble(generator: curandGenerator_t, outputPtr: *mut f64, n: usize, mean: f64, stddev: f64) -> curandStatus_t {
    match DYNAMIC_BINDINGS.get().expect("CUDA library not loaded. Did you forget to call #[cuda_load]?").curandGenerateNormalDouble {
        Some(____func) => unsafe { ____func(generator, outputPtr, n, mean, stddev) },
        None => panic!(
            "CUDA symbol '{}' not found in the loaded library. This typically happens when using a CUDA version older than the one the bindings were generated for.",
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandGenerateLogNormal(generator: curandGenerator_t, outputPtr: *mut f32, n: usize, mean: f32, stddev: f32) -> curandStatus_t {
    match DYNAMIC_BINDINGS.get().expect("CUDA library not loaded. Did you forget to call #[cuda_load]?").curandGenerateLogNormal {
        Some(____func) => unsafe { ____func(generator, outputPtr, n, mean, stddev) },
        None => panic!("CUDA symbol '{}' not found in the loaded library. This typically happens when using a CUDA version older than the one the bindings were generated for.", "curandGenerateLogNormal"),
    }
}
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandGenerateLogNormalDouble(generator: curandGenerator_t, outputPtr: *mut f64, n: usize, mean: f64, stddev: f64) -> curandStatus_t {
    match DYNAMIC_BINDINGS.get().expect("CUDA library not loaded. Did you forget to call #[cuda_load]?").curandGenerateLogNormalDouble {
        Some(____func) => unsafe { ____func(generator, outputPtr, n, mean, stddev) },
        None => panic!(
            "CUDA symbol '{}' not found in the loaded library. This typically happens when using a CUDA version older than the one the bindings were generated for.",
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandCreatePoissonDistribution(lambda: f64, discrete_distribution: *mut curandDiscreteDistribution_t) -> curandStatus_t {
    match DYNAMIC_BINDINGS.get().expect("CUDA library not loaded. Did you forget to call #[cuda_load]?").curandCreatePoissonDistribution {
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandDestroyDistribution(discrete_distribution: curandDiscreteDistribution_t) -> curandStatus_t {
    match DYNAMIC_BINDINGS.get().expect("CUDA library not loaded. Did you forget to call #[cuda_load]?").curandDestroyDistribution {
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandGeneratePoisson(generator: curandGenerator_t, outputPtr: *mut ::core::ffi::c_uint, n: usize, lambda: f64) -> curandStatus_t {
    match DYNAMIC_BINDINGS.get().expect("CUDA library not loaded. Did you forget to call #[cuda_load]?").curandGeneratePoisson {
        Some(____func) => unsafe { ____func(generator, outputPtr, n, lambda) },
        None => panic!("CUDA symbol '{}' not found in the loaded library. This typically happens when using a CUDA version older than the one the bindings were generated for.", "curandGeneratePoisson"),
    }
}
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandGeneratePoissonMethod(generator: curandGenerator_t, outputPtr: *mut ::core::ffi::c_uint, n: usize, lambda: f64, method: curandMethod_t) -> curandStatus_t {
    match DYNAMIC_BINDINGS.get().expect("CUDA library not loaded. Did you forget to call #[cuda_load]?").curandGeneratePoissonMethod {
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandGenerateBinomial(generator: curandGenerator_t, outputPtr: *mut ::core::ffi::c_uint, num: usize, n: ::core::ffi::c_uint, p: f64) -> curandStatus_t {
    match DYNAMIC_BINDINGS.get().expect("CUDA library not loaded. Did you forget to call #[cuda_load]?").curandGenerateBinomial {
        Some(____func) => unsafe { ____func(generator, outputPtr, num, n, p) },
        None => panic!("CUDA symbol '{}' not found in the loaded library. This typically happens when using a CUDA version older than the one the bindings were generated for.", "curandGenerateBinomial"),
    }
}
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandGenerateBinomialMethod(generator: curandGenerator_t, outputPtr: *mut ::core::ffi::c_uint, num: usize, n: ::core::ffi::c_uint, p: f64, method: curandMethod_t) -> curandStatus_t {
    match DYNAMIC_BINDINGS.get().expect("CUDA library not loaded. Did you forget to call #[cuda_load]?").curandGenerateBinomialMethod {
...
pub unsafe extern "C" fn curandGenerateSeeds(generator: curandGenerator_t) -> curandStatus_t {
    match DYNAMIC_BINDINGS.get().expect("CUDA library not loaded. Did you forget to call #[cuda_load]?").curandGenerateSeeds {
        Some(____func) => unsafe { ____func(generator) },
        None => panic!("CUDA symbol '{}' not found in the loaded library. This typically happens when using a CUDA version older than the one the bindings were generated for.", "curandGenerateSeeds"),
    }
}
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandGetDirectionVectors32(vectors: *mut *mut curandDirectionVectors32_t, set: curandDirectionVectorSet_t) -> curandStatus_t {
    match DYNAMIC_BINDINGS.get().expect("CUDA library not loaded. Did you forget to call #[cuda_load]?").curandGetDirectionVectors32 {
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandGetScrambleConstants32(constants: *mut *mut ::core::ffi::c_uint) -> curandStatus_t {
    match DYNAMIC_BINDINGS.get().expect("CUDA library not loaded. Did you forget to call #[cuda_load]?").curandGetScrambleConstants32 {
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandGetDirectionVectors64(vectors: *mut *mut curandDirectionVectors64_t, set: curandDirectionVectorSet_t) -> curandStatus_t {
    match DYNAMIC_BINDINGS.get().expect("CUDA library not loaded. Did you forget to call #[cuda_load]?").curandGetDirectionVectors64 {
        Some(____func) => unsafe { ____func(vectors, set) },
        None => panic!(
            "CUDA symbol '{}' not found in the loaded library. This typically happens when using a CUDA version older than the one the bindings were generated for.",
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandGetScrambleConstants64(constants: *mut *mut ::core::ffi::c_ulonglong) -> curandStatus_t {
    match DYNAMIC_BINDINGS.get().expect("CUDA library not loaded. Did you forget to call #[cuda_load]?").curandGetScrambleConstants64 {
        Some(____func) => unsafe { ____func(constants) },
        None => panic!(
            "CUDA symbol '{}' not found in the loaded library. This typically happens when using a CUDA version older than the one the bindings were generated for.",
