...
unsafe extern "C" {
    ...
    pub fn curandSetPseudoRandomGeneratorSeed(generator: curandGenerator_t, seed: ::std::os::raw::c_ulonglong) -> curandStatus_t;
}
#[cfg(not(feature = "runtime-link"))]
unsafe extern "C" {
    ...
    pub fn curandSetGeneratorOffset(generator: curandGenerator_t, offset: ::std::os::raw::c_ulonglong) -> curandStatus_t;
}
#[cfg(not(feature = "runtime-link"))]
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn curandSetQuasiRandomGeneratorDimensions(generator: curandGenerator_t, num_dimensions: ::std::os::raw::c_uint) -> curandStatus_t;
}
#[cfg(not(feature = "runtime-link"))]
unsafe extern "C" {
    ...
    pub fn curandGenerate(generator: curandGenerator_t, outputPtr: *mut ::std::os::raw::c_uint, num: usize) -> curandStatus_t;
}
#[cfg(not(feature = "runtime-link"))]
unsafe extern "C" {
    ...
    pub fn curandGenerateLongLong(generator: curandGenerator_t, outputPtr: *mut ::std::os::raw::c_ulonglong, num: usize) -> curandStatus_t;
}
#[cfg(not(feature = "runtime-link"))]
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn curandGeneratePoisson(generator: curandGenerator_t, outputPtr: *mut ::std::os::raw::c_uint, n: usize, lambda: f64) -> curandStatus_t;
}
#[cfg(not(feature = "runtime-link"))]
unsafe extern "C" {
    pub fn curandGeneratePoissonMethod(generator: curandGenerator_t, outputPtr: *mut ::std::os::raw::c_uint, n: usize, lambda: f64, method: curandMethod_t) -> curandStatus_t;
}
#[cfg(not(feature = "runtime-link"))]
unsafe extern "C" {
    pub fn curandGenerateBinomial(generator: curandGenerator_t, outputPtr: *mut ::std::os::raw::c_uint, num: usize, n: ::std::os::raw::c_uint, p: f64) -> curandStatus_t;
}
#[cfg(not(feature = "runtime-link"))]
unsafe extern "C" {
    pub fn curandGenerateBinomialMethod(generator: curandGenerator_t, outputPtr: *mut ::std::os::raw::c_uint, num: usize, n: ::std::os::raw::c_uint, p: f64, method: curandMethod_t) -> curandStatus_t;
}
#[cfg(not(feature = "runtime-link"))]
unsafe extern "C" {
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandGetProperty(type_: libraryPropertyType, value: *mut ::std::os::raw::c_int) -> curandStatus_t {
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandSetPseudoRandomGeneratorSeed(generator: curandGenerator_t, seed: ::std::os::raw::c_ulonglong) -> curandStatus_t {
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandSetGeneratorOffset(generator: curandGenerator_t, offset: ::std::os::raw::c_ulonglong) -> curandStatus_t {
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandSetQuasiRandomGeneratorDimensions(generator: curandGenerator_t, num_dimensions: ::std::os::raw::c_uint) -> curandStatus_t {
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandGenerate(generator: curandGenerator_t, outputPtr: *mut ::std::os::raw::c_uint, num: usize) -> curandStatus_t {
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandGenerateLongLong(generator: curandGenerator_t, outputPtr: *mut ::std::os::raw::c_ulonglong, num: usize) -> curandStatus_t {
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandGeneratePoisson(generator: curandGenerator_t, outputPtr: *mut ::std::os::raw::c_uint, n: usize, lambda: f64) -> curandStatus_t {
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandGeneratePoissonMethod(generator: curandGenerator_t, outputPtr: *mut ::std::os::raw::c_uint, n: usize, lambda: f64, method: curandMethod_t) -> curandStatus_t {
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandGenerateBinomial(generator: curandGenerator_t, outputPtr: *mut ::std::os::raw::c_uint, num: usize, n: ::std::os::raw::c_uint, p: f64) -> curandStatus_t {
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandGenerateBinomialMethod(generator: curandGenerator_t, outputPtr: *mut ::std::os::raw::c_uint, num: usize, n: ::std::os::raw::c_uint, p: f64, method: curandMethod_t) -> curandStatus_t {
...
#[cfg(feature = "runtime-link")]
#[inline(always)]
pub unsafe extern "C" fn curandGetScrambleConstants64(constants: *mut *mut ::std::os::raw::c_ulonglong) -> curandStatus_t {
