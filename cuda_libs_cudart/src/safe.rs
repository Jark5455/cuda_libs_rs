...
impl CudaExecutionContext {
    ...
    pub unsafe fn cudaExecutionCtxSynchronize(&self) -> cudaError_t {
        unsafe { crate::sys::cudaExecutionCtxSynchronize(self.handle) }
    }
    ...
    pub unsafe fn cudaExecutionCtxRecordEvent(&self, event: cudaEvent_t) -> cudaError_t {
        unsafe { crate::sys::cudaExecutionCtxRecordEvent(self.handle, event) }
    }
    ...
    pub unsafe fn cudaExecutionCtxWaitEvent(&self, event: cudaEvent_t) -> cudaError_t {
        unsafe { crate::sys::cudaExecutionCtxWaitEvent(self.handle, event) }
    }
}
...
pub unsafe fn cudaDeviceReset() -> cudaError_t {
    unsafe { crate::sys::cudaDeviceReset() }
}
...
pub unsafe fn cudaDeviceSynchronize() -> cudaError_t {
    unsafe { crate::sys::cudaDeviceSynchronize() }
}
...
pub unsafe fn cudaDeviceSetLimit(limit: cudaLimit, value: usize) -> cudaError_t {
    unsafe { crate::sys::cudaDeviceSetLimit(limit, value) }
}
...
pub unsafe fn cudaDeviceSetCacheConfig(cacheConfig: cudaFuncCache) -> cudaError_t {
    unsafe { crate::sys::cudaDeviceSetCacheConfig(cacheConfig) }
}
...
pub unsafe fn cudaIpcOpenEventHandle<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    mut event: T,
    handle: cudaIpcEventHandle_t,
) -> cudaError_t {
    unsafe { crate::sys::cudaIpcOpenEventHandle(event.as_mut_ptr() as *mut cudaEvent_t, handle) }
}
...
pub unsafe fn cudaIpcOpenMemHandle<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    mut devPtr: T,
...
pub unsafe fn cudaIpcCloseMemHandle<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    mut devPtr: T,
) -> cudaError_t {
    unsafe { crate::sys::cudaIpcCloseMemHandle(devPtr.as_mut_ptr() as *mut ::std::os::raw::c_void) }
}
pub unsafe fn cudaDeviceFlushGPUDirectRDMAWrites(
    ...
    unsafe { crate::sys::cudaDeviceFlushGPUDirectRDMAWrites(target, scope) }
}
...
pub unsafe fn cudaDeviceRegisterAsyncNotification<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    device: ::std::os::raw::c_int,
...
pub unsafe fn cudaDeviceUnregisterAsyncNotification(
    ...
    unsafe { crate::sys::cudaDeviceUnregisterAsyncNotification(device, callback) }
}
...
pub unsafe fn cudaDeviceSetSharedMemConfig(config: cudaSharedMemConfig) -> cudaError_t {
    unsafe { crate::sys::cudaDeviceSetSharedMemConfig(config) }
}
...
pub unsafe fn cudaGetLastError() -> cudaError_t {
    unsafe { crate::sys::cudaGetLastError() }
}
...
pub unsafe fn cudaPeekAtLastError() -> cudaError_t {
    unsafe { crate::sys::cudaPeekAtLastError() }
}
...
pub unsafe fn cudaDeviceSetMemPool(
    ...
    unsafe { crate::sys::cudaDeviceSetMemPool(device, memPool) }
}
...
pub unsafe fn cudaDeviceGetNvSciSyncAttributes<T: ::cuda_libs_cudart::types::CudaAsPtr>(
...
pub unsafe fn cudaChooseDevice<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    mut device: T,
    prop: *const cudaDeviceProp,
) -> cudaError_t {
    unsafe { crate::sys::cudaChooseDevice(device.as_mut_ptr() as *mut ::std::os::raw::c_int, prop) }
}
...
pub unsafe fn cudaInitDevice(
    ...
    unsafe { crate::sys::cudaInitDevice(device, deviceFlags, flags) }
}
...
pub unsafe fn cudaSetDevice(device: ::std::os::raw::c_int) -> cudaError_t {
    unsafe { crate::sys::cudaSetDevice(device) }
}
...
pub unsafe fn cudaSetValidDevices<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    mut device_arr: T,
    len: ::std::os::raw::c_int,
) -> cudaError_t {
    unsafe {
...
pub unsafe fn cudaSetDeviceFlags(flags: ::std::os::raw::c_uint) -> cudaError_t {
    unsafe { crate::sys::cudaSetDeviceFlags(flags) }
}
...
pub unsafe fn cudaCtxResetPersistingL2Cache() -> cudaError_t {
    unsafe { crate::sys::cudaCtxResetPersistingL2Cache() }
}
...
pub unsafe fn cudaStreamCopyAttributes(dst: cudaStream_t, src: cudaStream_t) -> cudaError_t {
    unsafe { crate::sys::cudaStreamCopyAttributes(dst, src) }
}
...
pub unsafe fn cudaStreamSetAttribute<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    hStream: cudaStream_t,
    attr: cudaLaunchAttributeID,
    value: T,
) -> cudaError_t {
...
pub unsafe fn cudaStreamWaitEvent(
    ...
    unsafe { crate::sys::cudaStreamWaitEvent(stream, event, flags) }
}
...
pub unsafe fn cudaStreamAddCallback<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    stream: cudaStream_t,
...
pub unsafe fn cudaStreamSynchronize(stream: cudaStream_t) -> cudaError_t {
    unsafe { crate::sys::cudaStreamSynchronize(stream) }
}
...
pub unsafe fn cudaStreamQuery(stream: cudaStream_t) -> cudaError_t {
    unsafe { crate::sys::cudaStreamQuery(stream) }
}
pub unsafe fn cudaStreamAttachMemAsync<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    stream: cudaStream_t,
    mut devPtr: T,
    length: usize,
    flags: ::std::os::raw::c_uint,
...
pub unsafe fn cudaStreamBeginCapture(
    ...
    unsafe { crate::sys::cudaStreamBeginCapture(stream, mode) }
}
...
pub unsafe fn cudaThreadExchangeStreamCaptureMode(mode: *mut cudaStreamCaptureMode) -> cudaError_t {
    unsafe { crate::sys::cudaThreadExchangeStreamCaptureMode(mode) }
}
...
pub unsafe fn cudaStreamEndCapture<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    stream: cudaStream_t,
    mut pGraph: T,
) -> cudaError_t {
    unsafe { crate::sys::cudaStreamEndCapture(stream, pGraph.as_mut_ptr() as *mut cudaGraph_t) }
}
...
pub unsafe fn cudaStreamIsCapturing(
    ...
    unsafe { crate::sys::cudaStreamIsCapturing(stream, pCaptureStatus) }
}
...
pub unsafe fn cudaEventRecord(event: cudaEvent_t, stream: cudaStream_t) -> cudaError_t {
    unsafe { crate::sys::cudaEventRecord(event, stream) }
}
pub unsafe fn cudaEventRecordWithFlags(
    ...
    unsafe { crate::sys::cudaEventRecordWithFlags(event, stream, flags) }
}
...
pub unsafe fn cudaEventQuery(event: cudaEvent_t) -> cudaError_t {
    unsafe { crate::sys::cudaEventQuery(event) }
}
...
pub unsafe fn cudaEventSynchronize(event: cudaEvent_t) -> cudaError_t {
    unsafe { crate::sys::cudaEventSynchronize(event) }
}
...
pub unsafe fn cudaEventElapsedTime<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    mut ms: T,
    start: cudaEvent_t,
    end: cudaEvent_t,
) -> cudaError_t {
...
pub unsafe fn cudaImportExternalMemory<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    mut extMem_out: T,
...
pub unsafe fn cudaImportExternalSemaphore<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    mut extSem_out: T,
...
pub unsafe fn cudaFuncSetCacheConfig<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    func: T,
...
pub unsafe fn cudaFuncSetAttribute<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    func: T,
...
pub unsafe fn cudaLaunchHostFunc<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    stream: cudaStream_t,
    fn_: cudaHostFn_t,
    mut userData: T,
) -> cudaError_t {
...
pub unsafe fn cudaLaunchHostFunc_v2<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    stream: cudaStream_t,
    fn_: cudaHostFn_t,
    mut userData: T,
...
pub unsafe fn cudaFuncSetSharedMemConfig<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    func: T,
...
pub unsafe fn cudaMallocManaged<T>(
    ...
    if status == crate::sys::cudaError::cudaSuccess {
        Ok(::cuda_libs_cudart::types::cuDeviceAllocation(
            dev_ptr as *mut T,
        ))
    } else {
        Err(status)
...
pub unsafe fn cudaHostAlloc<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    mut pHost: T,
    size: usize,
    flags: ::std::os::raw::c_uint,
) -> cudaError_t {
...
pub unsafe fn cudaHostRegister<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    mut ptr: T,
    size: usize,
    flags: ::std::os::raw::c_uint,
) -> cudaError_t {
...
pub unsafe fn cudaHostUnregister<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    mut ptr: T,
) -> cudaError_t {
...
pub unsafe fn cudaGetMipmappedArrayLevel<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    mut levelArray: T,
...
pub unsafe fn cudaMemcpy3D<T: ::cuda_libs_cudart::types::CudaAsPtr>(p: T) -> cudaError_t {
    unsafe { crate::sys::cudaMemcpy3D(p.as_const_ptr() as *const cudaMemcpy3DParms) }
}
...
pub unsafe fn cudaMemcpy3DPeer<T: ::cuda_libs_cudart::types::CudaAsPtr>(p: T) -> cudaError_t {
...
pub unsafe fn cudaMemcpy3DAsync<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    p: T,
    stream: cudaStream_t,
) -> cudaError_t {
    unsafe { crate::sys::cudaMemcpy3DAsync(p.as_const_ptr() as *const cudaMemcpy3DParms, stream) }
}
#[doc = " \\brief Copies memory between devices asynchronously.\n\n Perform a 3D memory copy according to the parameters specified in\n \\p p.  See the definition of the ::cudaMemcpy3DPeerParms structure\n for documentation of its parameters.\n\n \\param p      - Parameters for the memory copy\n \\param stream - Stream identifier\n\n \\return\n ::cudaSuccess,\n ::cudaErrorInvalidValue,\n ::cudaErrorInvalidDevice,\n ::cudaErrorInvalidPitchValue\n \\notefnerr\n \\note_async\n \\note_null_stream\n \\note_init_rt\n \\note_callback\n\n \\sa ::cudaMemcpy, ::cudaMemcpyPeer, ::cudaMemcpyAsync, ::cudaMemcpyPeerAsync,\n ::cudaMemcpy3DPeerAsync,\n ::cuMemcpy3DPeerAsync"]
pub unsafe fn cudaMemcpy3DPeerAsync<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    p: T,
    stream: cudaStream_t,
) -> cudaError_t {
    unsafe {
...
pub unsafe fn cudaArrayGetPlane<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    mut pPlaneArray: T,
    hArray: cudaArray_t,
...
pub unsafe fn cudaMemcpy2DToArray<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    dst: cudaArray_t,
    wOffset: usize,
    hOffset: usize,
    src: T,
...
pub unsafe fn cudaMemcpy2DFromArray<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    mut dst: T,
    dpitch: usize,
...
pub unsafe fn cudaMemcpy3DBatchAsync<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    numOps: usize,
    mut opList: T,
...
pub unsafe fn cudaMemcpy3DWithAttributesAsync<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    mut op: T,
    flags: ::std::os::raw::c_ulonglong,
    stream: cudaStream_t,
) -> cudaError_t {
...
pub unsafe fn cudaMemcpy2DToArrayAsync<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    dst: cudaArray_t,
    wOffset: usize,
    hOffset: usize,
    src: T,
...
pub unsafe fn cudaMemcpy2DFromArrayAsync<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    mut dst: T,
    dpitch: usize,
    src: cudaArray_const_t,
    wOffset: usize,
...
pub unsafe fn cudaMemset<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    mut devPtr: T,
    value: ::std::os::raw::c_int,
    count: usize,
) -> cudaError_t {
...
pub unsafe fn cudaMemset2D<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    mut devPtr: T,
    pitch: usize,
    value: ::std::os::raw::c_int,
    width: usize,
...
pub unsafe fn cudaMemset3D(
    ...
    unsafe { crate::sys::cudaMemset3D(pitchedDevPtr, value, extent) }
}
...
pub unsafe fn cudaMemsetAsync<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    mut devPtr: T,
    value: ::std::os::raw::c_int,
    count: usize,
    stream: cudaStream_t,
...
pub unsafe fn cudaMemset2DAsync<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    mut devPtr: T,
    pitch: usize,
    value: ::std::os::raw::c_int,
    width: usize,
...
pub unsafe fn cudaMemset3DAsync(
    ...
    unsafe { crate::sys::cudaMemset3DAsync(pitchedDevPtr, value, extent, stream) }
}
...
pub unsafe fn cudaMemPrefetchAsync<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    devPtr: T,
    count: usize,
...
pub unsafe fn cudaMemAdvise<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    devPtr: T,
    count: usize,
...
pub unsafe fn cudaMemcpyToArray<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    dst: cudaArray_t,
    wOffset: usize,
    hOffset: usize,
    src: T,
...
pub unsafe fn cudaMemcpyFromArray<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    mut dst: T,
    src: cudaArray_const_t,
    wOffset: usize,
    hOffset: usize,
...
pub unsafe fn cudaMemcpyToArrayAsync<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    dst: cudaArray_t,
    wOffset: usize,
    hOffset: usize,
    src: T,
...
pub unsafe fn cudaMemcpyFromArrayAsync<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    mut dst: T,
    src: cudaArray_const_t,
    wOffset: usize,
    hOffset: usize,
...
pub unsafe fn cudaMemPoolTrimTo(memPool: cudaMemPool_t, minBytesToKeep: usize) -> cudaError_t {
    unsafe { crate::sys::cudaMemPoolTrimTo(memPool, minBytesToKeep) }
}
...
pub unsafe fn cudaMemPoolSetAttribute<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    memPool: cudaMemPool_t,
...
pub unsafe fn cudaMemPoolGetAttribute<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    memPool: cudaMemPool_t,
    attr: cudaMemPoolAttr,
    mut value: T,
) -> cudaError_t {
...
pub unsafe fn cudaMemPoolSetAccess<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    memPool: cudaMemPool_t,
    descList: T,
    count: usize,
) -> cudaError_t {
...
pub unsafe fn cudaMemSetMemPool<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    mut location: T,
    type_: cudaMemAllocationType,
    memPool: cudaMemPool_t,
) -> cudaError_t {
...
pub unsafe fn cudaMemPoolExportToShareableHandle<T: ::cuda_libs_cudart::types::CudaAsPtr>(
...
pub unsafe fn cudaDeviceCanAccessPeer<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    mut canAccessPeer: T,
    device: ::std::os::raw::c_int,
...
pub unsafe fn cudaDeviceEnablePeerAccess(
    ...
    unsafe { crate::sys::cudaDeviceEnablePeerAccess(peerDevice, flags) }
}
...
pub unsafe fn cudaDeviceDisablePeerAccess(peerDevice: ::std::os::raw::c_int) -> cudaError_t {
    unsafe { crate::sys::cudaDeviceDisablePeerAccess(peerDevice) }
}
...
pub unsafe fn cudaGraphicsUnregisterResource(resource: cudaGraphicsResource_t) -> cudaError_t {
    unsafe { crate::sys::cudaGraphicsUnregisterResource(resource) }
}
...
pub unsafe fn cudaGraphicsResourceSetMapFlags(
    ...
    unsafe { crate::sys::cudaGraphicsResourceSetMapFlags(resource, flags) }
}
...
pub unsafe fn cudaGraphicsMapResources<T: ::cuda_libs_cudart::types::CudaAsPtr>(
...
pub unsafe fn cudaGraphicsUnmapResources<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    count: ::std::os::raw::c_int,
    mut resources: T,
    stream: cudaStream_t,
) -> cudaError_t {
...
pub unsafe fn cudaLogsRegisterCallback<T: ::cuda_libs_cudart::types::CudaAsPtr>(
...
pub unsafe fn cudaLogsUnregisterCallback(callback: cudaLogsCallbackHandle) -> cudaError_t {
    unsafe { crate::sys::cudaLogsUnregisterCallback(callback) }
}
...
pub unsafe fn cudaLogsCurrent<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    mut iterator_out: T,
    flags: ::std::os::raw::c_uint,
) -> cudaError_t {
    unsafe { crate::sys::cudaLogsCurrent(iterator_out.as_mut_ptr() as *mut cudaLogIterator, flags) }
}
...
pub unsafe fn cudaGraphKernelNodeSetParams<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    node: cudaGraphNode_t,
    pNodeParams: T,
) -> cudaError_t {
    unsafe {
...
pub unsafe fn cudaGraphKernelNodeCopyAttributes(
    ...
    unsafe { crate::sys::cudaGraphKernelNodeCopyAttributes(hDst, hSrc) }
}
...
pub unsafe fn cudaGraphKernelNodeSetAttribute<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    hNode: cudaGraphNode_t,
    attr: cudaLaunchAttributeID,
    value: T,
) -> cudaError_t {
...
pub unsafe fn cudaGraphMemcpyNodeGetParams(
    node: cudaGraphNode_t,
) -> Result<cudaMemcpy3DParms, crate::sys::cudaError> {
    let mut out_1: std::mem::MaybeUninit<cudaMemcpy3DParms> = std::mem::MaybeUninit::uninit();
    let status =
        unsafe { crate::sys::cudaGraphMemcpyNodeGetParams(node, out_1.as_mut_ptr() as *mut _) };
    if status == crate::sys::cudaError::cudaSuccess {
        unsafe { Ok(out_1.assume_init()) }
    } else {
        Err(status)
...
pub unsafe fn cudaGraphMemcpyNodeSetParams<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    node: cudaGraphNode_t,
    pNodeParams: T,
) -> cudaError_t {
    unsafe {
...
pub unsafe fn cudaGraphMemsetNodeSetParams<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    node: cudaGraphNode_t,
    pNodeParams: T,
) -> cudaError_t {
    unsafe {
...
pub unsafe fn cudaGraphHostNodeSetParams<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    node: cudaGraphNode_t,
    pNodeParams: T,
) -> cudaError_t {
    unsafe {
...
pub unsafe fn cudaGraphEventRecordNodeSetEvent(
    ...
    unsafe { crate::sys::cudaGraphEventRecordNodeSetEvent(node, event) }
}
...
pub unsafe fn cudaGraphEventWaitNodeSetEvent(
    ...
    unsafe { crate::sys::cudaGraphEventWaitNodeSetEvent(node, event) }
}
...
pub unsafe fn cudaGraphMemFreeNodeGetParams<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    node: cudaGraphNode_t,
    mut dptr_out: T,
) -> cudaError_t {
    unsafe {
...
pub unsafe fn cudaDeviceGraphMemTrim(device: ::std::os::raw::c_int) -> cudaError_t {
    unsafe { crate::sys::cudaDeviceGraphMemTrim(device) }
}
pub unsafe fn cudaDeviceGetGraphMemAttribute<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    device: ::std::os::raw::c_int,
...
pub unsafe fn cudaDeviceSetGraphMemAttribute<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    device: ::std::os::raw::c_int,
    attr: cudaGraphMemAttributeType,
    mut value: T,
) -> cudaError_t {
...
pub unsafe fn cudaGraphClone<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    mut pGraphClone: T,
...
pub unsafe fn cudaGraphNodeFindInClone<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    mut pNode: T,
...
pub unsafe fn cudaGraphInstantiate<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    mut pGraphExec: T,
    graph: cudaGraph_t,
    flags: ::std::os::raw::c_ulonglong,
) -> cudaError_t {
...
pub unsafe fn cudaGraphInstantiateWithFlags<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    mut pGraphExec: T,
    graph: cudaGraph_t,
    flags: ::std::os::raw::c_ulonglong,
) -> cudaError_t {
...
pub unsafe fn cudaGraphExecKernelNodeSetParams<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    hGraphExec: cudaGraphExec_t,
    node: cudaGraphNode_t,
    pNodeParams: T,
) -> cudaError_t {
...
pub unsafe fn cudaGraphExecMemcpyNodeSetParams<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    hGraphExec: cudaGraphExec_t,
    node: cudaGraphNode_t,
    pNodeParams: T,
) -> cudaError_t {
...
pub unsafe fn cudaGraphExecMemsetNodeSetParams<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    hGraphExec: cudaGraphExec_t,
    node: cudaGraphNode_t,
    pNodeParams: T,
) -> cudaError_t {
...
pub unsafe fn cudaGraphExecHostNodeSetParams<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    hGraphExec: cudaGraphExec_t,
    node: cudaGraphNode_t,
    pNodeParams: T,
) -> cudaError_t {
...
pub unsafe fn cudaGraphNodeSetEnabled(
    ...
    unsafe { crate::sys::cudaGraphNodeSetEnabled(hGraphExec, hNode, isEnabled) }
}
...
pub unsafe fn cudaGraphExecUpdate<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    hGraphExec: cudaGraphExec_t,
    hGraph: cudaGraph_t,
    mut resultInfo: T,
) -> cudaError_t {
...
pub unsafe fn cudaGraphUpload(graphExec: cudaGraphExec_t, stream: cudaStream_t) -> cudaError_t {
    unsafe { crate::sys::cudaGraphUpload(graphExec, stream) }
}
...
pub unsafe fn cudaGraphLaunch(graphExec: cudaGraphExec_t, stream: cudaStream_t) -> cudaError_t {
    unsafe { crate::sys::cudaGraphLaunch(graphExec, stream) }
}
...
pub unsafe fn cudaGraphDebugDotPrint<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    graph: cudaGraph_t,
    path: T,
    flags: ::std::os::raw::c_uint,
) -> cudaError_t {
...
pub unsafe fn cudaUserObjectRetain(
    ...
    unsafe { crate::sys::cudaUserObjectRetain(object, count) }
}
...
pub unsafe fn cudaUserObjectRelease(
    ...
    unsafe { crate::sys::cudaUserObjectRelease(object, count) }
}
...
pub unsafe fn cudaGraphRetainUserObject(
    ...
    unsafe { crate::sys::cudaGraphRetainUserObject(graph, object, count, flags) }
}
...
pub unsafe fn cudaGraphReleaseUserObject(
    ...
    unsafe { crate::sys::cudaGraphReleaseUserObject(graph, object, count) }
}
...
pub unsafe fn cudaGraphNodeSetParams<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    node: cudaGraphNode_t,
    mut nodeParams: T,
) -> cudaError_t {
    unsafe {
...
pub unsafe fn cudaGraphExecNodeSetParams<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    graphExec: cudaGraphExec_t,
    node: cudaGraphNode_t,
    mut nodeParams: T,
) -> cudaError_t {
...
>(
    ...
    unsafe {
        crate::sys::cudaLibraryLoadData(
            library.as_mut_ptr() as *mut cudaLibrary_t,
            code.as_const_ptr() as *const ::std::os::raw::c_void,
            jitOptions.as_mut_ptr() as *mut cudaJitOption,
            jitOptionsValues.as_mut_ptr() as *mut *mut ::std::os::raw::c_void,
            numJitOptions,
            libraryOptions.as_mut_ptr() as *mut cudaLibraryOption,
            libraryOptionValues.as_mut_ptr() as *mut *mut ::std::os::raw::c_void,
            numLibraryOptions,
        )
    }
}
...
>(
    ...
    unsafe {
        crate::sys::cudaLibraryLoadFromFile(
            library.as_mut_ptr() as *mut cudaLibrary_t,
            fileName.as_const_ptr() as *const ::std::os::raw::c_char,
            jitOptions.as_mut_ptr() as *mut cudaJitOption,
            jitOptionsValues.as_mut_ptr() as *mut *mut ::std::os::raw::c_void,
            numJitOptions,
            libraryOptions.as_mut_ptr() as *mut cudaLibraryOption,
...
pub unsafe fn cudaLibraryUnload(library: cudaLibrary_t) -> cudaError_t {
    unsafe { crate::sys::cudaLibraryUnload(library) }
}
...
pub unsafe fn cudaLibraryGetKernel(
    ...
    let status =
        unsafe { crate::sys::cudaLibraryGetKernel(out_0.as_mut_ptr() as *mut _, library, name) };
    if status == crate::sys::cudaError::cudaSuccess {
        unsafe { Ok(out_0.assume_init()) }
    } else {
        Err(status)
...
pub unsafe fn cudaLibraryGetGlobal(
    ...
    let mut out_1: std::mem::MaybeUninit<usize> = std::mem::MaybeUninit::uninit();
    let status = unsafe {
        crate::sys::cudaLibraryGetGlobal(dptr, out_1.as_mut_ptr() as *mut _, library, name)
    };
    if status == crate::sys::cudaError::cudaSuccess {
        unsafe { Ok(out_1.assume_init()) }
    } else {
...
pub unsafe fn cudaLibraryGetManaged(
    ...
    let mut out_1: std::mem::MaybeUninit<usize> = std::mem::MaybeUninit::uninit();
    let status = unsafe {
        crate::sys::cudaLibraryGetManaged(dptr, out_1.as_mut_ptr() as *mut _, library, name)
    };
    if status == crate::sys::cudaError::cudaSuccess {
        unsafe { Ok(out_1.assume_init()) }
    } else {
...
>(
    ...
    unsafe {
        crate::sys::cudaLibraryGetUnifiedFunction(
            fptr.as_mut_ptr() as *mut *mut ::std::os::raw::c_void,
            library,
            symbol.as_const_ptr() as *const ::std::os::raw::c_char,
        )
    }
}
...
pub unsafe fn cudaLibraryGetKernelCount(
    ...
    let mut out_0: std::mem::MaybeUninit<::std::os::raw::c_uint> = std::mem::MaybeUninit::uninit();
    let status =
        unsafe { crate::sys::cudaLibraryGetKernelCount(out_0.as_mut_ptr() as *mut _, lib) };
    if status == crate::sys::cudaError::cudaSuccess {
        unsafe { Ok(out_0.assume_init()) }
    } else {
        Err(status)
...
pub unsafe fn cudaLibraryEnumerateKernels<T: ::cuda_libs_cudart::types::CudaAsPtr>(
    mut kernels: T,
    numKernels: ::std::os::raw::c_uint,
    lib: cudaLibrary_t,
) -> cudaError_t {
    unsafe {
        crate::sys::cudaLibraryEnumerateKernels(
            kernels.as_mut_ptr() as *mut cudaKernel_t,
            numKernels,
            lib,
        )
    }
...
pub unsafe fn cudaDeviceGetExecutionCtx(
    ...
    let status =
        unsafe { crate::sys::cudaDeviceGetExecutionCtx(out_0.as_mut_ptr() as *mut _, device) };
    if status == crate::sys::cudaError::cudaSuccess {
        unsafe { Ok(out_0.assume_init()) }
    } else {
        Err(status)
