...
pub unsafe fn cudaMallocManaged<T: ::cuda_libs::types::CudaAsPtr>(
    mut devPtr: T,
    size: usize,
    flags: ::std::os::raw::c_uint,
) -> cudaError_t {
    unsafe {
        crate::sys::cudaMallocManaged(
            devPtr.as_mut_ptr() as *mut *mut ::std::os::raw::c_void,
            size,
            flags,
        )
...
pub unsafe fn cudaMalloc<T: ::cuda_libs::types::CudaAsPtr>(
    mut devPtr: T,
    size: usize,
) -> cudaError_t {
    unsafe {
        crate::sys::cudaMalloc(
            devPtr.as_mut_ptr() as *mut *mut ::std::os::raw::c_void,
            size,
        )
    }
...
pub unsafe fn cudaMallocHost<T: ::cuda_libs::types::CudaAsPtr>(
    mut ptr: T,
    size: usize,
) -> cudaError_t {
    unsafe {
        crate::sys::cudaMallocHost(ptr.as_mut_ptr() as *mut *mut ::std::os::raw::c_void, size)
    }
}
...
>(
    ...
    unsafe {
        crate::sys::cudaMallocPitch(
            devPtr.as_mut_ptr() as *mut *mut ::std::os::raw::c_void,
            pitch.as_mut_ptr() as *mut usize,
            width,
            height,
        )
    }
...
>(
    ...
    unsafe {
        crate::sys::cudaMallocArray(
            array.as_mut_ptr() as *mut cudaArray_t,
            desc.as_const_ptr() as *const cudaChannelFormatDesc,
            width,
            height,
            flags,
        )
...
pub unsafe fn cudaFree<T: ::cuda_libs::types::CudaAsPtr>(mut devPtr: T) -> cudaError_t {
    unsafe { crate::sys::cudaFree(devPtr.as_mut_ptr() as *mut ::std::os::raw::c_void) }
}
...
pub unsafe fn cudaFreeHost<T: ::cuda_libs::types::CudaAsPtr>(mut ptr: T) -> cudaError_t {
    unsafe { crate::sys::cudaFreeHost(ptr.as_mut_ptr() as *mut ::std::os::raw::c_void) }
}
...
pub unsafe fn cudaFreeArray(array: cudaArray_t) -> cudaError_t {
    unsafe { crate::sys::cudaFreeArray(array) }
}
...
pub unsafe fn cudaFreeMipmappedArray(mipmappedArray: cudaMipmappedArray_t) -> cudaError_t {
    unsafe { crate::sys::cudaFreeMipmappedArray(mipmappedArray) }
}
...
pub unsafe fn cudaHostUnregister<T: ::cuda_libs::types::CudaAsPtr>(mut ptr: T) -> cudaError_t {
...
pub unsafe fn cudaMalloc3D<T: ::cuda_libs::types::CudaAsPtr>(
    mut pitchedDevPtr: T,
    extent: cudaExtent,
) -> cudaError_t {
    unsafe { crate::sys::cudaMalloc3D(pitchedDevPtr.as_mut_ptr() as *mut cudaPitchedPtr, extent) }
}
...
pub unsafe fn cudaMemcpy3D<T: ::cuda_libs::types::CudaAsPtr>(p: T) -> cudaError_t {
...
pub unsafe fn cudaMemcpy3DPeer<T: ::cuda_libs::types::CudaAsPtr>(p: T) -> cudaError_t {
...
pub unsafe fn cudaMallocAsync<T: ::cuda_libs::types::CudaAsPtr>(
    mut devPtr: T,
    size: usize,
    hStream: cudaStream_t,
) -> cudaError_t {
    unsafe {
        crate::sys::cudaMallocAsync(
            devPtr.as_mut_ptr() as *mut *mut ::std::os::raw::c_void,
            size,
            hStream,
        )
...
pub unsafe fn cudaFreeAsync<T: ::cuda_libs::types::CudaAsPtr>(
    mut devPtr: T,
    hStream: cudaStream_t,
) -> cudaError_t {
    unsafe {
        crate::sys::cudaFreeAsync(devPtr.as_mut_ptr() as *mut ::std::os::raw::c_void, hStream)
    }
}
...
pub unsafe fn cudaMallocFromPoolAsync<T: ::cuda_libs::types::CudaAsPtr>(
    mut ptr: T,
    size: usize,
    memPool: cudaMemPool_t,
    stream: cudaStream_t,
    ...
    unsafe {
        crate::sys::cudaMallocFromPoolAsync(
...
pub unsafe fn cudaLibraryEnumerateKernels<T: ::cuda_libs::types::CudaAsPtr>(
    mut kernels: T,
...
pub unsafe fn cudaExecutionCtxGetDevice(
    ...
    let mut out_0: std::mem::MaybeUninit<::std::os::raw::c_int> = std::mem::MaybeUninit::uninit();
    let status =
        unsafe { crate::sys::cudaExecutionCtxGetDevice(out_0.as_mut_ptr() as *mut _, ctx) };
    if status == crate::sys::cudaError::cudaSuccess {
        unsafe { Ok(out_0.assume_init()) }
    } else {
        Err(status)
